...
Usage:
  python managed_demo.py           # requires managed DB env vars
  python managed_demo.py --sqlite # force local SQLite demo
...
This script will create a `radiology_procedures` table and insert demo rows.
"""
...
def main() -> None:
    ...
    # Read env vars (support multiple naming conventions)
    ...
    if args.sqlite:
        ...
        print("[MODE] missing DB creds: falling back to SQLite for demo purposes")
